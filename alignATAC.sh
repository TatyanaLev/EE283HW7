...
#mkdir alignments # inside RAWDATA/ATACseq

ref="/data/class/ecoevo283/tzhuravl/RAWDATA/ref/dmel-all-chromosome-r6.13.fasta"
path="/data/class/ecoevo283/tzhuravl/RAWDATA/ATACseq/alignments"
file="/data/class/ecoevo283/tzhuravl/RAWDATA/ATACseq/ATACprefixes.txt"
